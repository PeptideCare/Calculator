...
<body>
    ...
    <div class="subtitle">
       <img src="profileicon.png" class="profileicon">
        전공 추천
    ...
    <div class="grid">
        <div class="portalbtn">
            <a href="credit_input.html"><button class="unchecked_portal_btn">학점 입력</button></a>
            <a href="credit_check.html"><button class="unchecked_portal_btn">학점 확인</button></a>
            <a href="credit_residual.html"><button class="unchecked_portal_btn">남은 학점</button></a>
            <a href="course_recom.html"><button class="checked_portal_btn">과목 추천</button></a>
